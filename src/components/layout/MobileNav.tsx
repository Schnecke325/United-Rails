  ...
  return (
    <div className="lg:hidden">
      ...
      {open && (
        ...
        >
          <div className="flex h-16 items-center justify-between border-b border-[var(--border-subtle)] px-[var(--gutter)]">
          ...
          <nav
            ...
            className="flex-1 overflow-y-auto px-[var(--gutter)] py-6"
          >
          ...
          <div className="border-t border-[var(--border-subtle)] px-[var(--gutter)] py-5">
            <Link
              href={routes.builder}
              className={cn(
