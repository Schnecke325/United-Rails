 ...
 * Bewerbungsstatus und Serverstatus — ein Vokabular für die ganze Seite.
 */
...
const tones: Record<SignalTone, string> = {
  ...
  caution:
    'text-signal-caution bg-[var(--signal-caution-soft)] border-[var(--signal-caution)]',
  info: 'text-signal-info bg-[var(--signal-info-soft)] border-[var(--signal-info)]',
  neutral: 'text-fg-muted bg-[var(--surface-3)] border-[var(--border-default)]',
};
