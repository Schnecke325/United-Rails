...
Farben, Schriftgrößen und Abstände stehen ausschließlich in `src/styles/tokens.css`.
Wer das Erscheinungsbild ändert, ändert diese Datei, nicht die Komponenten.
